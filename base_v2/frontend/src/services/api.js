...
export const featureRequestAPI = {
  createRequest: (requestData) => api.post('/feature-requests', requestData),
  getRequests: () => api.get('/feature-requests'),
  updateRequest: (id, updateData) => api.put(`/feature-requests/${id}`, updateData),
};
